...
const props = defineProps({
  ...
  defineEmits(['incrementar-cantidad',
   'decrementar-cantidad', 
   'agregar-carrito',
    'eliminar-producto',
    'vaciar-carrito'])

    //Ver clase 63, se explica el computed property
        ...
        <div class="container-xl">
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    <h1 class="display-2 fw-bold">¿Quieres comprar tu guitarra soñada?</h1>
                    <p class="mt-5 fs-5 text-white">GuitarLA en una pagina destinada a la venta de guitarras electricas con los
                        mejores precios
                        Echa un vistazo a nuestros precios y lo podrás comprobar por ti mismo
                    </p>
                    <p class="text-primary fs-1 fw-black">Compra el modelo {{ guitarra.nombre }} Vai por $ 250</p>
                    <button 
                    type="button" 
